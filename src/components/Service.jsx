    ...
    return (
        ...
        <div className='w-full bg-white py-16 px-4'>
            ...
            <div className='flex flex-col justify-center'>
                <p className='text-[#35e1e3] font-bold'>OUR SERVICES</p>
                <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>PRIVATE JET CHARTER FOR BUSINESS TRAVEL</h1>
