...
const Service = () => {
    return (
        <div className='w-full py-16 px-4 '>
            ...
            <img className='w-[500px] mx-auto py-20 ' src={Gambar7} alt='/' />
            <div className='flex flex-col justify-center '>    
                <h1 className='text-[#35e1e3] md:text-2xl sm:text-3xl text-2xl font-bold py-2  '>PRIVATE JET CHARTER FOR BUSINESS TRAVEL</h1>
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center'>
                <h1 className='text-[#35e1e3] md:text-2xl sm:text-3xl text-2xl font-bold py-2'>PRIVATE JET CHARTER FOR HOLIDAYS</h1>
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center'>
                <h1 className='text-[#35e1e3] md:text-2xl sm:text-3xl text-2xl font-bold py-2'>PRIVATE JET CHARTER FOR MEDICAL AIR AMBULANCE FLIGHT</h1>
